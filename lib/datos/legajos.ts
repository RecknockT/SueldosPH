...
const COLUMNAS =
  "id, nombre, cuil, cargo_id, categoria, fecha_ingreso, consorcio_nombre, consorcio_cuit, uf, adicionales, aportes, horas_fijas, ajustes, activo, notas, art_alicuota, art_monto_fijo, seguro_vida, detraccion, contribucion_solidaria, created_at, updated_at"
