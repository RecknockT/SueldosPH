...
const COLUMNAS =
  "id, nombre, cuil, cargo_id, categoria, fecha_ingreso, consorcio_nombre, consorcio_cuit, uf, adic_rem, adic_no_rem, adicionales, aportes, activo, notas, created_at, updated_at"
